...
import { FaLocationDot, FaCalendarDays, FaCheck, FaExclamation, FaVolumeHigh, FaMicrophone } from "react-icons/fa6"
...
const SearchModal = () => {
  ...
  const bodyContent = (
    <div className="flex flex-col gap-8">
      ...
      {/* Content Area */}
      <div className="min-h-[400px] flex flex-col justify-center px-4">
        {step === STEPS.LOCATION && (
          <div className="space-y-8 animate-fadeIn">
            <div className="text-center space-y-4">
              <div className="relative inline-block">
                ...
                <p className="text-gray-500 mt-2">Discover amazing places around the world</p>
              </div>
            </div>
            ...
            {locationValue && (
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 animate-slideIn flex items-center gap-3">
          ...
          <div className="space-y-8 animate-fadeIn">
            <div className="text-center space-y-4">
              <div className="relative inline-block">
                ...
                <p className="text-gray-500 mt-2">Select your preferred dates</p>
              </div>
            </div>

            {/* Status Messages */}
            {errorMessage && (
              <div className="bg-red-50 border border-red-100 rounded-lg p-4 animate-slideIn flex items-start gap-3">
            ...
            {successMessage && (
              <div className="bg-green-50 border border-green-100 rounded-lg p-4 animate-slideIn flex items-start gap-3">
            ...
            {dateRange.startDate && dateRange.endDate && (
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 animate-slideIn flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-700">Selected dates:</p>
