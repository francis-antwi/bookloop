                    ...
                    ">
                        {currentUser ? (
                            <>
                                ...
                                <div className="px-6 py-5 bg-gradient-to-r from-slate-50/80 to-blue-50/80 border-b border-slate-200/70 backdrop-blur-sm">
                            ...
                            <>
                                ...
                                <div className="px-6 py-5 border-b border-slate-200/70 bg-gradient-to-r from-blue-50/50 to-indigo-50/50">
