...
const ListingHead: React.FC<ListingHeadProps> = ({
  ...
  return (
    <>
      ...
      {/* Image Gallery or No Image Placeholder */}
      <div className="relative group">
        {hasImages ? (
          ...
          <div className="relative w-full h-[65vh] bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-2xl flex items-center justify-center">
            <div className="text-center p-8">
              {/* No Image Icon */}
              <div className="mx-auto w-24 h-24 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center mb-6">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 dark:text-gray-400">
              ...
              <p className="text-gray-500 dark:text-gray-500 text-sm max-w-md mx-auto">
                This listing doesn't have any images yet. Check back later or contact the listing owner for more details.
              </p>
            </div>
          </div>
        )}
      ...
      {/* Enhanced Fullscreen Modal - Only render if images exist */}
